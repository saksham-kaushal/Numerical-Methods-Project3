		...
		\begin{enumerate} [label*=\textbf{(\alph*)}]
			...
			\item 
				\subitem \textbf{Methods  --} 
					...
					\begin{figure} [h]
						\lstinputlisting[caption=(Snippet of) prob1ad.m - Analytical estimates and observed 	number distributions with distance of \(10^5\) particles, 
...
%					\subitem \textbf{Discussions  --}
			...
			% ---------------------------------- (d) ---------------------------------------------
				...
				\item
					...
					\subitem \textbf{Results --}
					Numerical values obtained from the simulation give an eventual dimensionless energy of \(\tilde{E}_s \approx 16.2244\) for the secondary star. Substituting for non-dimensionless values in equation \ref{eq:3-secondary_velocity_infty}, we get,
					\begin{equation}
						\begin{gathered}
							\begin{aligned}
		...
		\section{Complete Matlab Programs}
			...
			\vspace{2mm}		
			\lstinputlisting[title=prob1aa.m]{../problem1/prob1aa.m} 
			\vspace{5mm}
			\lstinputlisting[title=prob1ab.m]{../problem1/prob1ab.m} 
			\vspace{5mm}
			\lstinputlisting[title=prob1ac.m]{../problem1/prob1ac.m} 
			\vspace{5mm}
			\lstinputlisting[title=prob1ad.m]{../problem1/prob1ad.m} 
			\vspace{5mm}
			
			\subsection{Problem 2} 
			\vspace{2mm}			
			\lstinputlisting[title=binary.m]{../problem2/binary.m} 
			\vspace{5mm}
			\lstinputlisting[title=f.m]{../problem2/f.m} 
			\vspace{5mm}
			\lstinputlisting[title=RK4.m]{../problem2/RK4.m} 
			\vspace{5mm}
			\lstinputlisting[title=energy.m]{../problem2/energy.m} 
			\vspace{5mm}
			\lstinputlisting[title=orbitplot.m]{../problem2/orbitplot.m} 
			\vspace{5mm}
			\lstinputlisting[title=energyplot.m]{../problem2/energyplot.m} 
			\vspace{5mm}
			...
			\vspace{2mm}
				...
				\vspace{2mm}
				\lstinputlisting[title=HVS.m]{../problem3d/HVS.m} 
				\vspace{5mm}
				\lstinputlisting[title=initialc.m]{../problem3d/initialc.m} 
				\vspace{5mm}
				\lstinputlisting[title=f.m]{../problem3d/f.m} 
				\vspace{5mm}
				\lstinputlisting[title=energy.m]{../problem3d/energy.m} 
				\vspace{5mm}
				\lstinputlisting[title=RK4.m]{../problem3d/RK4.m} 
				\vspace{5mm}
				\lstinputlisting[title=script4.m]{../problem3d/script4.m} 
				\vspace{5mm}
				
				\subsubsection{Part f} 
				\vspace{2mm}
				\lstinputlisting[title=HVS.m]{../problem3f/HVS.m} 
				\vspace{5mm}
				\lstinputlisting[title=initialc\_prograde.m]{../problem3f/initialc_prograde.m}
				\vspace{5mm}
				\lstinputlisting[title=initialc\_retrograde.m]{../problem3f/initialc_retrograde.m} 
				\vspace{5mm}
				\lstinputlisting[title=f.m]{../problem3f/f.m} 
				\vspace{5mm}
				\lstinputlisting[title=energy.m]{../problem3f/energy.m} 
				\vspace{5mm}
				\lstinputlisting[title=RK4.m]{../problem3f/RK4.m} 
				\vspace{5mm}
				\lstinputlisting[title=script4.m]{../problem3f/script4.m} 
				\vspace{5mm}
		\end{appendices}
...
% References
% random walk
% time taken by photon 1e
% circular binary
% hyper velocity stars - one or both ejected
% alternate cause of hvs