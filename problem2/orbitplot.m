...
plot(xp,yp,'LineWidth',2,'DisplayName','Primary') % plot the orbit of the primary star
...
plot(xs,ys,'r:','LineWidth',2,'DisplayName','Secondary') % plot the orbit of the secondary star
